...
//// 承载一次发言的文本、情绪与音频对齐数据,不带行为 [@busybee 2026-06-13] ////
class Utterance {
  constructor() {
    // 发言文本
    this.text = '';
  ...
  //// 从音频与时长算出对齐信息,气泡时长取音频加余量与最短时长的较大者 [@busybee 2026-06-13] ////
