...
// 后鼻韵尾 -ng 在 ン 前补长音ー(オーン、イーン 等),拉出比 -n 更长、更靠后的鼻音,与 -n 区分开。
const FINAL_KANA = {
  a: 'ア', o: 'オ', e: 'ウ', ê: 'エ',
  ai: 'アイ', ei: 'エイ', ao: 'アオ', ou: 'オウ',
  an: 'アン', en: 'エン', ang: 'アーン', eng: 'エーン', ong: 'オーン',
  er: 'アル',
  i: 'イ', ia: 'イア', ie: 'イエ', iao: 'イアオ', iu: 'イウ', iou: 'イウ',
  ian: 'イェン', in: 'イン', iang: 'イアーン', ing: 'イーン', iong: 'イオーン',
  u: 'ウ', ua: 'ウア', uo: 'ウオ', uai: 'ウアイ', ui: 'ウイ', uei: 'ウイ',
  uan: 'ウアン', un: 'ウン', uen: 'ウン', uang: 'ウアーン', ueng: 'ウオーン',
