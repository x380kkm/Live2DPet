...
function features(melody) {
  ...
  return { noteCount: n, stepRatio, leapRate, repeatRate, rangeSemitones, beatAlign, pitchClassEntropy, selfSimilarity };
}
//// /抽一段旋律的内部一致性特征 ////
