...
const I18N = {
  en: {
    ...
    'weight.title': 'Action Weights',
    'weight.hint': 'Relative tendency to chat versus run a mod action. Higher emotion raises the mod tendency.',
    'weight.dialogue': 'Dialogue total weight',
    'weight.mod': 'Mod total weight',
    ...
    'tts.toneControl': 'Emotion tone (experimental)',
  ...
  zh: {
    ...
    'emo.save': '保存表情设置',
    'weight.title': '动作权重',
    'weight.hint': '闲聊与做模组动作的相对倾向。情绪越高,做模组的倾向越被抬升。',
    'weight.dialogue': '对话总权重',
    'weight.mod': '模组总权重',
    'tts.title': 'VOICEVOX TTS',
  ...
  ja: {
    ...
    'emo.save': '表情設定を保存',
    'weight.title': 'アクション重み',
    'weight.hint': '雑談とモッド動作の相対的な傾き。感情が高いほどモッドの傾きが上がります。',
    'weight.dialogue': '対話の総重み',
    'weight.mod': 'モッドの総重み',
    'tts.title': 'VOICEVOX TTS',
