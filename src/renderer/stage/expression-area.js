...
//// 表达区两个占用者的名字,由本文件单一定义 [@x380kkm 2026-06-13] ////
...
export class ExpressionArea {
  //// 经构造注入两占用者的激活与停用钩子,本身不触 DOM [@x380kkm 2026-06-13] ////
  ...
  //// 让一个占用者占主导:停用原主导、激活新主导,返回被替下的占用者名 [@x380kkm 2026-06-13] ////
  takeOver(occupant) {
  ...
  //// 释放当前主导,表达区回到无人占用 [@x380kkm 2026-06-13] ////
  release() {
