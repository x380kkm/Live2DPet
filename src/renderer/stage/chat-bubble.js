...
//// 气泡尺寸预算:折叠态用小上限,展开态用大上限,均不超过表达区给的上限 [@x380kkm 2026-06-13] ////
...
//// 把文本量算出的内容尺寸钳进当前态的预算区间 [@x380kkm 2026-06-13] ////
...
export class ChatBubble {
  //// 经构造注入气泡元素、文本元素、窗口尺寸能力与预算,默认折叠 [@x380kkm 2026-06-13] ////
  ...
  //// 显示一段文本:写入文本、折叠为默认小、按预算调窗 [@x380kkm 2026-06-13] ////
  show(text) {
  ...
  //// 展开到更大上限并重算窗口尺寸 [@x380kkm 2026-06-13] ////
  expand() {
  ...
  //// 折叠回默认小上限并重算窗口尺寸 [@x380kkm 2026-06-13] ////
  collapse() {
    if (!this.expanded) return;
    this.expanded = false;
    this._applyBudget();
  ...
  //// 量文本元素撑出的内容宽高,无元素时回退到预算下限 [@x380kkm 2026-06-13] ////
  _measure() {
