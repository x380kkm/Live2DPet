...
//// 取得本文件所需的三个 electron 子系统,优先用注入,缺省时才向 electron 取 [@busybee 2026-06-13] ////
...
//// 释放源数组里的原生图像引用,尽早回收 GPU 与进程内存 [@busybee 2026-06-13] ////
...
//// 截取指定窗口或主屏,产出 base64 的 JPEG,封掉 desktopCapturer 与原生图像类型 [@busybee 2026-06-13] ////
...
//// 查系统空闲秒数,封掉 powerMonitor [@busybee 2026-06-13] ////
...
//// 取主屏工作区尺寸,封掉 screen,产出平直的宽高数据 [@busybee 2026-06-13] ////
