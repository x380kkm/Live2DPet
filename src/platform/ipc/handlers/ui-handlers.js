...
//// 宠物窗口可选的方形尺寸,上下文菜单据此列出尺寸子菜单 [@x380kkm 2026-06-13] ////
const PET_SIZES = [200, 300, 400, 500];

//// 推送到宠物窗口的通道名:角色更新、尺寸已变(气泡改由独立窗口承载,不再走宠物窗口) [@x380kkm 2026-06-14] ////
...
//// 装配展示与交互处理器:取注入的窄接口,返回按通道名索引的处理器表 [@x380kkm 2026-06-13] ////
function createUiHandlers(deps) {
  ...
  //// 组出上下文菜单的平直模板:尺寸子菜单改窗并回报、设置项显示或新建、关闭项关窗 [@x380kkm 2026-06-13] ////
  ...
  //// 设置窗口存活则显示并聚焦,否则新建 [@x380kkm 2026-06-13] ////
  ...
  //// 在宠物窗口打开开发者工具,缺宠物窗口仍回成功 [@x380kkm 2026-06-13] ////
  ...
  //// 合并角色数据补丁并推给宠物窗口热更,缺宠物窗口只更新快照 [@x380kkm 2026-06-13] ////
...
//// 把展示与交互处理器表逐项经 ipc-router 注册 [@x380kkm 2026-06-13] ////
