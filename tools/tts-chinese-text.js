...
const { textToTokens, textToAccentKana } = require('../src/domain/tts/chinese-text');
const { applyChineseProsody, CHINESE_QUERY_DEFAULTS } = require('../src/domain/tts/chinese-phonemes');
...
const { kana, plan } = textToAccentKana(text);
console.log(`文本:${text}`);
